...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="./assets/images/logo.png" width="162" height="10" alt="Learni logo">
      </a>
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <h1 class="h1 section-title">
              The Most Effective  <span class="span">Exchange</span> Programme
            </h1>

            <p class="hero-text">
              You can switch careers by studying with us. We offer a wide range of courses to help you grow. 
            </p>
  ...
  <footer class="footer" style="background-image: url('./assets/images/footer-bg.png')">
      ...
      <div class="container grid-list">
        ...
        <div class="footer-brand">
          ...
          <div class="wrapper">
            ...
            <a href="mailto:info@Learni.com" class="footer-link">info@Learni.com</a>
          </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          Copyright 2022 All Rights Reserved by <a href="#" class="copyright-link">Durgesh4993</a>
        </p>
  ...
  <button class="chatbot__button">
    <span class="material-symbols-outlined"><i class="bi bi-chat-dots"></i></span>
